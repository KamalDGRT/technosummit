                ...
                <div class="mu-hero-area">
                    ...
                    <div class="mu-hero-featured-area">
                        ...
                        <div class="mu-hero-featured-content animated slideInDown">
                            ...
                            <h1>AI WORKSHOP</h1>
                            <h2>Microsoft Club and Tamil Club</h2>
                            <br><br>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="mu-about-left">
                                        <img class="animated slideInLeft" src="<?php echo Yii::$app->params['frontendUrl'] . 'event/images/event_aiworkshop.png'; ?>" alt="AI Workshop"> </div>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <div class="row">
                                        <div class=" mu-about-right animated slideInRight">
                                            ...
                                            <p>
                                                ...
                                                AI is a conjunction of computational and technological excellence.
                                            </p><br>
                                            <p>
                                                And that's what the world is moving towards. With the advancement that takes place at this rate, AI is one of the
                                                most important weapons that we need to equip ourselves with.
                                            </p><br>
                                            <p>
                                                For a better tomorrow, artificial intelligence is something that you can't dispose of. Then why are you waiting, register
                                                here to experience real excitement in learning AI.
                                            </p><br>
                                        </div>
                                    </div>

                                    <!-- Row starts  Rules and regulations 
                                    <div class="row">
                                        <div class="col-md-12">
