                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mu-sponsors-area animated zoomInRight">
                                                ...
                                                <div class="myPanel">
                                                    <ul class="list-group">
                                                        <li class="list-group-item"><span>1. Each participant is given a maximum time of 6 hours to develop a website. </span></li>
                                                        <li class="list-group-item"><span>2. After developing the website, screenshots of the website content (final output) along with source code must be attached and put into a zipped folder. </span></li>
                                                        <li class="list-group-item"><span>3. Then, the zipped folder has to be uploaded in the Google Classroom using their mail id. </span></li>
                                                        <li class="list-group-item"><span>4. The Club President and the staff in charge will then verify the same. Then the selected students will be intimated through the mail. </span></li>
                                                            ...
                                                            <div class="panel-heading">
                                                                <h4 class="panel-title">
                                                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true">
                                                                        ...
                                                                        Question 1
                                                                        How should I design the website?
                                                                    </a>
                                                                </h4>
                                                            </div>
                                                            ...
                                                            <div class="panel-heading">
                                                                <h4 class="panel-title">
                                                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                                                                        <span class="fa fa-angle-up"></span>
                                                                        Question 2
                                                                        How can I submit my final code?
                                                                    </a>
                                                                </h4>
                                                            </div>
                                                            ...
                                                            <div class="panel-heading">
                                                                <h4 class="panel-title">
                                                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseFour">
                                                                        <span class="fa fa-angle-up"></span>
                                                                        Question 4
                                                                        What will be the total duration of the competition?
                                                                    </a>
                                                                </h4>
                                                            </div>
